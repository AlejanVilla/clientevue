                ...
                <div class="card-body">
                    <form v-on:submit="guardar">
                        ...
                        <div class="input-group mb-3">
                            ...
                            maxlength="250" placeholder="Estado">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-solid fa-comment"></i></span>
                            <input type="text" v-model="contents" id="contenido" class="form-control"
                            maxlength="250" placeholder="Contenido">
                        </div>
...
<script>
    import { show_alerta, enviarSolicitudP} from '../funciones';
    import { useRoute } from 'vue-router';
    import axios from 'axios';
    export default{
        data(){
            return{
                id:0,name:'',description:'',state:'',contents:'',url:'http://127.0.0.1:8000/api/posts'
            }
        },
        mounted(){
        ...
        ,methods:{
            ...
            guardar(){
                ...
                if(this.name.trim() === ''){
                    ...
                    enviarSolicitudP('PUT',parametros,this.url,'Post Actualizada');
                }
            }
        }
    }
